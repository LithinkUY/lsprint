...
type Props = AboutSection & { editMode?: boolean; onUpdateField?: (field: string, value: any) => void };

const About: React.FC<Props> = ({ title, subtitle, content, imageUrl, button, titleFont, titleColor, textFont, textColor, editMode, onUpdateField }) => {
  return (
