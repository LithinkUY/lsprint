...
const ContactForm: React.FC<ContactFormProps> = ({ section, contactInfo, editMode, onUpdateField, onUpdateContactInfo }) => {
  ...
  return (
    <div className="container mx-auto px-6 py-16">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="bg-white rounded-lg shadow p-6 md:col-span-12" style={{ gridColumn: `span ${Math.round(formWidth * 12)} / span ${Math.round(formWidth * 12)}` }}>
        ...
        {/* Columna lateral con info de contacto y sociales (si existe) */}
